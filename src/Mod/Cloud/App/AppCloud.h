...
// SPDX-FileCopyrightText: 2019 Jean-Marie Verdun <jmverdun3@gmail.com>
...
struct AmzData* ComputeDigestAmzS3v2(
    char* operation,
    char* data_type,
    const char* target,
    const char* Secret,
...
struct AmzDatav4* ComputeDigestAmzS3v4(
    char* operation,
    const char* server,
    char* data_type,
    const char* target,
...
struct curl_slist* BuildHeaderAmzS3v2(
    const char* URL,
    const char* TCPPort,
...
public:
        ...
        : Py::ExtensionModule<Module>("Cloud")
    {
        ...
        add_varargs_method("Region", &Module::sCloudRegion, "Region(string) -- Specify Amazon s3 Region");
