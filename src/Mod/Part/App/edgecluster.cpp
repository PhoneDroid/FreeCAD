...
// SPDX-FileCopyrightText: 2010 Joachim Zettler <Joachim.Zettler@gmx.de>
...
void Edgecluster::Perform()
{
    ...
    do {
        m_edges.clear();
        // Lets start with a vertice that only has one edge (that means start or end point of the
        // merged edges!)
