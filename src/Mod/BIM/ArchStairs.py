...
class _Stairs(ArchComponent.Component):
    ...
    def setProperties(self, obj):
        ...
        if not "Length" in pl:
            obj.addProperty(
                ...
                "Stairs",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The length of these stairs, if no baseline is defined"
                ),
                locked=True,
            )
        if not "Width" in pl:
        ...
        if not "NumberOfSteps" in pl:
            obj.addProperty(
                ...
                "NumberOfSteps",
                "Steps",
                QT_TRANSLATE_NOOP("App::Property", "The number of risers in these stairs"),
                locked=True,
            )
        if not "TreadDepth" in pl:
            obj.addProperty(
                ...
                "TreadDepth",
                "Steps",
                QT_TRANSLATE_NOOP("App::Property", "The depth of the treads of these stairs"),
                locked=True,
            )
        ...
        if not "RiserHeight" in pl:
            obj.addProperty(
                ...
                "RiserHeight",
                "Steps",
                QT_TRANSLATE_NOOP("App::Property", "The height of the risers of these stairs"),
                locked=True,
            )
        ...
        if not (
            "BlondelRatio" in pl
            and obj.getTypeIdOfProperty("BlondelRatio") == "App::PropertyLength"
        ):
        ...
        if not hasattr(obj, "LandingDepth"):
            obj.addProperty(
                ...
                "LandingDepth",
                "Steps",
                QT_TRANSLATE_NOOP("App::Property", "The depth of the landing of these stairs"),
                locked=True,
            )
        ...
        if not hasattr(obj, "AbsTop"):
            obj.addProperty(
                ...
                "Segment and Parts",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The 'absolute' top level of a flight of stairs leads to"
                ),
                locked=True,
            )
        ...
        if not hasattr(obj, "RailingLeft"):
            obj.addProperty(
                ...
                "RailingLeft",
                "Segment and Parts",
                QT_TRANSLATE_NOOP("App::Property", "Name of Railing object (left) created"),
                locked=True,
            )
        if not hasattr(obj, "RailingRight"):
            obj.addProperty(
                ...
                "RailingRight",
                "Segment and Parts",
                QT_TRANSLATE_NOOP("App::Property", "Name of Railing object (right) created"),
                locked=True,
            )
        ...
        if not hasattr(obj, "OutlineLeftAll"):
            obj.addProperty(
                ...
                "OutlineLeftAll",
                "Segment and Parts",
                QT_TRANSLATE_NOOP("App::Property", "The 'left outline' of all segments of stairs"),
                locked=True,
            )
        ...
        if not hasattr(obj, "OutlineRightAll"):
            obj.addProperty(
                ...
                "OutlineRightAll",
                "Segment and Parts",
                QT_TRANSLATE_NOOP("App::Property", "The 'right outline' of all segments of stairs"),
                locked=True,
            )
        ...
        if not hasattr(obj, "RailingHeightLeft"):
            obj.addProperty(
                ...
                "Segment and Parts",
                QT_TRANSLATE_NOOP(
                    "App::Property", "Height of Railing on Left hand side from Stairs or Landing"
                ),
                locked=True,
            )
        if not hasattr(obj, "RailingHeightRight"):
            obj.addProperty(
                ...
                "Segment and Parts",
                QT_TRANSLATE_NOOP(
                    "App::Property", "Height of Railing on Right hand side from Stairs or Landing"
                ),
                locked=True,
            )
        ...
        if not "Structure" in pl:
            obj.addProperty(
                ...
                "Structure",
                "Structure",
                QT_TRANSLATE_NOOP("App::Property", "The type of structure of these stairs"),
                locked=True,
            )
        ...
        if not "StructureThickness" in pl:
            obj.addProperty(
                ...
                "Structure",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The thickness of the massive structure or of the stringers"
                ),
                locked=True,
            )
        ...
        if (
            ...
            obj.addProperty(
                ...
                "Structure",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The offset between the border of the stairs and the structure"
                ),
                locked=True,
            )
            if value:
        ...
        if not "StringerOverlap" in pl:
            obj.addProperty(
                ...
                "Structure",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The overlap of the stringers above the bottom of the treads"
                ),
                locked=True,
            )
        if not "DownSlabThickness" in pl:
            obj.addProperty(
                ...
                "DownSlabThickness",
                "Structure",
                QT_TRANSLATE_NOOP("App::Property", "The thickness of the lower floor slab"),
                locked=True,
            )
        if not "UpSlabThickness" in pl:
            obj.addProperty(
                ...
                "UpSlabThickness",
                "Structure",
                QT_TRANSLATE_NOOP("App::Property", "The thickness of the upper floor slab"),
                locked=True,
            )
        ...
        if not "ArchSketchData" in pl:
            obj.addProperty(
                ...
                QT_TRANSLATE_NOOP(
                    "App::Property",
                    "Use Base ArchSketch (if used) data (e.g. selected edge, widths, aligns) instead of Stairs' properties",
                ),
                locked=True,
            )
    ...
    def execute(self, obj):
        ...
        if baseProxy and obj.ArchSketchData and hasattr(baseProxy, "getStairsBaseShapeEdgesInfo"):
            propSetUuid = self.ArchSkPropSetPickedUuid
            info = baseProxy.getStairsBaseShapeEdgesInfo(obj.Base, propSetUuid=propSetUuid)
            if info:
        ...
        if (not base) and obj.Width.Value and obj.Height.Value and (obj.NumberOfSteps > 0):
            ...
            if self.ensureBase(obj):
                ...
                # if not ArchSketchData and obj.ArchSketchEdges (whether stock Sketch or ArchSketch)
                    ...
                    len(obj.Base.Shape.Edges) == 1
                ):  # elif not obj.ArchSketchData and len(obj.Base.Shape.Edges) == 1:
                    edgeL = [obj.Base.Shape.Edges[0]]
                elif (
                    len(obj.Base.Shape.Edges) > 1
                ):  # elif not obj.ArchSketchData and len(obj.Base.Shape.Edges) > 1:  # >= 1
            ...
            # Build Stairs if there is no obj.Base or even obj.Base is not valid
                ...
                if not obj.Length.Value:
                    ...
                    return
                edgeL = [
                    Part.LineSegment(Vector(0, 0, 0), Vector(obj.Length.Value, 0, 0)).toShape()
                ]
                        ...
                        if obj.NumberOfSteps > 1:
                            ...
                            if edge.Vertexes[0].Point.z > edge.Vertexes[1].Point.z:
                                edge = Part.LineSegment(
                                    edge.Vertexes[1].Point, edge.Vertexes[0].Point
                                ).toShape()
        ...
        if not any(pArc):  # i.e. no arc ... though any([0, '', False]):- is False
            ...
            for k, a in enum_outlinePoints:
                if k < (
                    ...
                    if pArc[k] is None:
                        edges.append(
                            Part.LineSegment(outlinePoints[k], outlinePoints[k + 1]).toShape()
                        )
                    else:
                        edges.append(
                            Part.Arc(outlinePoints[k], pArc[k], outlinePoints[k + 1]).toShape()
                        )
    ...
    def returnOutlines(
        ...
        for i, edge in enum_edges:
            ...
            if i > 0:
                try:
                    if widthOtherSegments[i - 1] > 0 or (not widthFirstSegmentDefault):
                        netWidthI = (
                            widthOtherSegments[i - 1] - offsetHLeft.Value - offsetHRight.Value
                        )  # 2*offsetH
            ...
            if isLine:
                ...
                dvec2 = edge.tangentAt((edge.LastParameter + edge.FirstParameter) / 2).cross(
                    Vector(0, 0, 1)
                )
            ...
            if isLine:
                ...
                p3.append(
                    p2[i].add(vWidth[i]).add(Vector(0, 0, (offsetVRight - offsetVLeft).Value))
                )
                p4.append(
                    p3[i].add(DraftVecUtils.neg(vLength[i])).add(Vector(0, 0, railStartRiser.Value))
                )
                pArc1.append(None)
                pArc2.append(None)
            elif isArc:
                ...
                p4.append(
                    p1[i].add(vWidth[i].add(Vector(0, 0, (offsetVRight - offsetVLeft).Value)))
                )
                pArc1.append(
                ...
                pArc2.append(
                    pArc1[i].add(vWidth2.add(Vector(0, 0, (offsetVRight - offsetVLeft).Value)))
                )
    ...
    def makeStraightStairs(
        ...
        vHeight=None,
        vNose=None,
        vRiserThickness=None,
        vTreadThickness=None,
        structure=None,
        structureThickness=None,
        downSlabThickness=None,
        upSlabThickness=None,
        structureOffset=None,
        stringerWidth=None,
        ...
        if not vLength:
            vLength = DraftVecUtils.scaleTo(
                v_proj, float(v_proj.Length) / (numOfSteps - 1)
            )  # TODO need this float?
        ...
        if not callByMakeStraightStairsWithLanding:
            if obj.LastSegment:  # TODO
                ...
                vBase = Vector(
                    vBase.x, vBase.y, lastSegmentAbsTop.z
                )  # TODO # use Last Segment top's z-coordinate
        ...
        for i in range(numOfSteps - 1):
            ...
            r1 = p1
            p1 = p1.add(vNose)
            p2 = p1.add(DraftVecUtils.neg(vNose)).add(
                vLength
            )  # TODO 2025.4.20 Tested: Seems DraftVecUtils.neg(x) == -x
            p3 = p2.add(vWidth)
            ...
            r2 = r1.add(
                -vHeight
            )  # vResHeight  # TODO 2025.4.20 Tested: Seems DraftVecUtils.neg(x) == -x
            if i == 0:
            ...
            if stringerWidth and structureThickness:
                ...
                if obj.Structure == "One stringer":
                    if structureOffset:
                        ...
                        mvec = DraftVecUtils.scaleTo(
                            vWidth, (vWidth.Length / 2) - stringerWidth / 2
                        )
                    pol.translate(mvec)
                    struct = pol.extrude(evec)
                elif obj.Structure == "Two stringers":
    ...
    def makeStraightStairsWithLanding(
        ...
        width=None,
        align=None,
        treadDepthEnforce=None,
        riserHeightEnforce=None,
        flight=None,
    ):
        ...
        if numOfSteps is not None:
            ...
            obj.NumberOfSteps < 2
        ):  # elif numOfSteps is None and obj.NumberOfSteps < 2:  # Would not be called by execute()
            print("Fewer than 2 steps, unable to create/update stairs")
            return
        ...
        if treadDepthEnforce and treadDepthEnforce != "Auto":
            ...
            treadDepthEnforce == "Auto" or obj.TreadDepthEnforce == 0
        ...
        # if obj.RiserHeightEnforce == 0:
            ...
            riserHeightEnforce == "Auto" or obj.RiserHeightEnforce == 0
        ):  # elif riserHeightEnforce is None and ...
            if round(v.z, Draft.precision()) != 0:
                h = v.z
            else:
                h = height
        ...
        if hasLanding:
            ...
            # if obj.Flight in ["HalfTurnLeft", "HalfTurnRight"]:
            if (flight in halfTurn) or (flight is None and (obj.Flight in halfTurn)):
                ...
                if (align == "Left" and halfTurnLR == "HalfTurnLeft") or (
                    align == "Right" and halfTurnLR == "HalfTurnRight"
                ):
                    p3r = p2
                ...
                if p3r:
                    p4r = p3r.add(
                        DraftVecUtils.scale(-vLength, numOfSteps - (landingStep + 1)).add(
                            Vector(0, 0, (numOfSteps - landingStep) * hstep)
                        )
                    )
            ...
            )  # TODO numOfSteps=None, callByMakeStraightStairsWithLanding=True
    ...
    def connectRailingVector(self, obj, outlineRailL, outlineRailR, pArcRailL, pArcRailR):
        ...
        if obj.LastSegment:
            ...
            if (
                outlineLeftAll[-1] - obj.OutlineLeft[0]
            ).Length < 0.01:  # To avoid 2 points overlapping fail creating LineSegment # TODO to allow tolerance Part.LineSegment / edge.toShape() allow?
