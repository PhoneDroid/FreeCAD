...
# ***************************************************************************
# *                                                                         *
# SPDX-FileCopyrightText: 2020 Yorik van Havre <yorik@uncreated.net>
# *                                                                         *
    ...
    def makeSketch(windowtype, width, height, h1, h2, h3, w1, w2, o1, o2):
        ...
        if width * height * h1 * h2 * w1 * w2 == 0:
            FreeCAD.Console.PrintError(
                "Width, Height, H1, H2, W1 and W2 parameters cannot be zero. Aborting\n"
            )
            return
        ...
        if windowtype == "Fixed":
            ...
            wp.extend(
                ["InnerGlass", "Glass panel", "Wire3", str(w2 / gla), str(o2 + w2 / 2) + "+V"]
            )
            ...
            wp.extend(
                ["RightGlass", "Glass panel", "Wire5", str(w2 / gla), str(o2 + w2 / 2) + "+V"]
            )
            ...
            wp.extend(
                ["LowerGlass", "Glass panel", "Wire3", str(w2 / gla), str(o2 + w2 + w2 / 2) + "+V"]
            )
            wp.extend(["UpperFrame", "Frame", "Wire4,Wire5", fw, str(o2) + "+V"])
            wp.extend(
                ["UpperGlass", "Glass panel", "Wire5", str(w2 / gla), str(o2 + w2 / 2) + "+V"]
            )
            ...
            wp.extend(
                ["RightGlass", "Glass panel", "Wire5", str(w2 / gla), str(o2 + w2 + w2 / 2) + "+V"]
            )
            ...
            wp.extend(
                ["LeftMostGlass", "Glass panel", "Wire3", str(w2 / gla), str(o2 + w2 / 2) + "+V"]
            )
            wp.extend(["LeftFrame", "Frame", "Wire4,Wire5", fw, str(o2 + w2) + "+V"])
            wp.extend(
                ["LeftGlass", "Glass panel", "Wire5", str(w2 / gla), str(o2 + w2 + w2 / 2) + "+V"]
            )
            wp.extend(["RightFrame", "Frame", "Wire6,Wire7", fw, str(o2 + w2) + "+V"])
            wp.extend(
                ["RightGlass", "Glass panel", "Wire7", str(w2 / gla), str(o2 + w2 + w2 / 2) + "+V"]
            )
            wp.extend(["RightMostFrame", "Frame", "Wire8,Wire9", fw, str(o2) + "+V"])
            wp.extend(
                ["RightMostGlass", "Glass panel", "Wire9", str(w2 / gla), str(o2 + w2 / 2) + "+V"]
            )
