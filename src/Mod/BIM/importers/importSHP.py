...
def checkShapeFileLibrary():
    ...
    try:
        ...
        url = (
            "https://raw.githubusercontent.com/GeospatialPython/pyshp/refs/tags/2.4.1/shapefile.py"
        )
        if FreeCAD.GuiUp:
            ...
            reply = QtGui.QMessageBox.question(
                ...
                translate(
                    ...
                    "%1",
                    '<a href="https://github.com/GeospatialPython/pyshp">https://github.com/GeospatialPython/pyshp</a>',
                ),
            ...
            if reply == QtGui.QMessageBox.Yes:
                ...
                if not u:
                    FreeCAD.Console.PrintError(
                        translate("Arch", "Error: Unable to download from %1").replace("%1", url)
                        + "\n"
                    )
                    return False
                b = u.read()
                ...
                FreeCAD.Console.PrintError(
                    translate("Arch", "Shapefile module not downloaded. Aborting.") + "\n"
                )
                return False
        else:
            FreeCAD.Console.PrintError(
