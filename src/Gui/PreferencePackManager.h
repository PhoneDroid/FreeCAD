// SPDX-FileCopyrightText: 2021 Chris Hennes <chennes@pioneerlibrarysystem.org>
...
public:
     ...
     * packs) by using the toggleVisibility function.
     */
     ...
     *
     * If the named preferencePack does not exist, this creates it on disk. If it does exist, this
